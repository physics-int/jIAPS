...
$$ \textbf{t}= \hbar(\textbf{k}_{x}-\textbf{k}_{z})\Gamma_{sc} \eta_{0}\frac{4\delta_{i}^{'} \gamma_{c}^{2} (\textbf{k}_{x}-\textbf{k}_{z}).\textbf{v}}{(\gamma_{c}^{2}+\delta_{+ +}^{2})(\gamma_{c}^{2}+\delta_{- -}^{2})} +<br />

\hbar(\textbf{k}_{x}+\textbf{k}_{z})\Gamma_{sc} \eta_{0}\frac{4\delta_{i}^{'}\gamma_{c}^{2}(\textbf{k}_{x}+\textbf{k}_{z}).\textbf{v}}{(\gamma_{c}^{2}+\delta_{+ -}^{2})(\gamma_{c}^{2}+\delta_{- +}^{2})}$$ (4)
